...
JNIEXPORT jstring JNICALL
Java_com_thanh_1nguyen_test_1count_1down_external_KeyStore_getAdsBannerAbout(JNIEnv *env, jobject thiz) {
 return (*env)->  NewStringUTF(env, key_ads_banner_about);
}

JNIEXPORT jstring JNICALL
Java_com_thanh_1nguyen_test_1count_1down_external_KeyStore_getAdsBannerMusic(JNIEnv *env, jobject thiz) {
